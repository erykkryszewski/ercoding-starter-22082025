    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="two-images__item" style="height:<?php echo $item['height']; ?>px">
          <?php if (!empty($item['image_class'])): ?> <?php echo wp_get_attachment_image($item['image'], 'full', '', ['class' => $item['image_class']]); ?> <?php else: ?> <?php echo
          wp_get_attachment_image($item['image'], 'full', '', ['class' => 'object-fit-cover']); ?> <?php endif; ?> <?php if (!empty($item['link'])): ?>
