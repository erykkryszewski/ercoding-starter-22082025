    ...
    <div class="row text-image-decorated__row <?php if ('reverse' == $direction) { echo 'text-image-decorated__row--reverse'; } ?>">
      ...
      <div class="col-12 col-lg-4 col-xl-3">
        <div class="text-image-decorated__column">
          <div>
            <div
              class="text-image-decorated__picture <?php if ('reverse' == $direction) { echo 'text-image-decorated__picture--reverse'; } ?> <?php if ('true' == $circle) { echo 'text-image-decorated__picture--circle'; } ?>"
            >
              <?php echo wp_get_attachment_image($image, 'large', '', ['class' =>
              'object-fit-cover']); ?>
            </div>
